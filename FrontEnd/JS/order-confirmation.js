...
const titreConfirmation = createTag("h2", 'display-5 m-3', 'confirmation de commande');
confirmation.append(titreConfirmation);
...
function createTag(tag, className, content) {
    ...
    const titreConfirmation = document.createElement(tag);
    titreConfirmation.className = className;
    titreConfirmation.innerHTML = content;
